...
def create_snake(
    ...
    # In Cheese Mode, snake starts with 3 segments all at the same position
    # In other modes, snake starts with 1 segment
    if cheese_mode:
        initial_size = 3
        initial_segments = [(start_x, start_y)] * 3  # All segments stacked at start
    else:
        initial_size = 1
        initial_segments = []
